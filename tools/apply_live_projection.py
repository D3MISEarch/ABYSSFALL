...
with tarfile.open(fileobj=io.BytesIO(archive), mode="r:gz") as bundle:
    members = [member for member in bundle.getmembers() if member.name != ".github/workflows/persistent-level-flow-tests.yml"]
